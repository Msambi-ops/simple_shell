...
/**
 * _setenv - This function looks up an environment variable,
 * by name and sets it to the corresponding
 * value string.
 * @params: parameters
*/
...
/**
 * _unsetenv - This function looks up an environment variable by name,
 *  and sets it to the corresponding value string.
