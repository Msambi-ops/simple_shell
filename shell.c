...
/**
 * main - Starting point for a basic shell
 * @argc: The number of arguments
 * @argv: list of arguments terminated by a null character
 * @env: A list of environment variables terminated by a null character
 *
 * Return: 0 on success
 */
...
/**
 * init_param - Set up parameters
 * @argv: Argument provided on the command line
